...
let iconCounts = { lr: 182, dfe: 140 }; // Default fallback values - automatically updated by nodeJS
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loadFlairs = function() {
    ...
    let dfTEQ = parseRanges('2,10,13,16,23,28,34-35,40-41,48,51,59-60,68,73,75,80,88,90,99,103,108,111,118,126,133,136');
