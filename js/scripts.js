...
let iconCounts = { lr: 185, dfe: 143 }; // Default fallback values - automatically updated by nodeJS
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loadFlairs = function() {
    ...
    let lrTEQ = parseRanges('1,9-10,17,20,29,36,42,44-45,53,57,64-65,70,79,82,93,95-96,100,106,110,113,126,129,131,140,143,146,150-151,153-154,171-172,180,186');
    let lrSTR = parseRanges('4,8,14,21-22,32-33,35,41,43,52,54,62,67,69,77,80,84-85,90,97,105,111,115,120,128,137,142,148,152,156,164-166,169,174,178-179,184-185');
