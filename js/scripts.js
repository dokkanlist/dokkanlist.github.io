...
let iconCounts = { lr: 186, dfe: 144 }; // Default fallback values - automatically updated by nodeJS
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  loadFlairs = function() {
    ...
    let lrTEQ = parseRanges('1,9-10,17,20,29,36,42,44-45,53,57,64-65,70,79,82,93,95-96,100,106,110,113,126,129,131,140,143,146,150-151,153-154,171-172,179,185-6');
